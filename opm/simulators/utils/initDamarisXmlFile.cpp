...
<simulation name="opm-flow" language="c" xmlns="http://damaris.gforge.inria.fr/damaris/model" comment="This is an in-built Damaris config file. Export the environment variable FLOW_DAMARIS_XML_FILE pointing to a copy of this file if changes are required" >
<architecture>
    <domains count="1"/>
...
<data>
    ...
    <variable name="KRNSW_OW"  layout="zonal_layout_usmesh"  type="scalar"  visualizable="true" mesh=""  unit=""  centering="zonal"     time-varying="true" select-file="GLOBAL_CELL_INDEX"  store="#"   script="PythonScript" />
    <variable name="KRNSW_GO"  layout="zonal_layout_usmesh"  type="scalar"  visualizable="true" mesh=""  unit=""  centering="zonal"     time-varying="true" select-file="GLOBAL_CELL_INDEX"  store="#"   script="PythonScript" />
    <variable name="PCSWM_GO"  layout="zonal_layout_usmesh"  type="scalar"  visualizable="true" mesh=""  unit=""  centering="zonal"     time-varying="true" select-file="GLOBAL_CELL_INDEX"  store="#"   script="PythonScript" />
    <variable name="PCSWM_OW"  layout="zonal_layout_usmesh"  type="scalar"  visualizable="true" mesh=""  unit=""  centering="zonal"     time-varying="true" select-file="GLOBAL_CELL_INDEX"  store="#"   script="PythonScript" />
    <variable name="PPCW"      layout="zonal_layout_usmesh"  type="scalar"  visualizable="true" mesh=""  unit="Bar"  centering="zonal"  time-varying="true" select-file="GLOBAL_CELL_INDEX"  store="#"   script="PythonScript" />
    ...
    <variable name="RS"        layout="zonal_layout_usmesh"  type="scalar"  visualizable="true" mesh=""  unit="Bar"  centering="zonal"  time-varying="true" select-file="GLOBAL_CELL_INDEX"  store="#"   script="PythonScript" comment="Dissolved Gas units Gas Oil Ratio" />
    <variable name="RV"        layout="zonal_layout_usmesh"  type="scalar"  visualizable="true" mesh=""  unit="Bar"  centering="zonal"  time-varying="true"  select-file="GLOBAL_CELL_INDEX" store="#"  script="PythonScript" />
